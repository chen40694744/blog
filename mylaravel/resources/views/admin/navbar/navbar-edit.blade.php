...
@section('content')
	...
	<section class="Hui-article-box">
		<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="{{url('admin/index')}}" class="maincolor">首页</a> <span class="c-999 en">&gt;</span>
			...
			<span class="c-666">自定义导航修改</span></nav>
		<div class="Hui-article">
			<article class="cl pd-20">
		<form class="form form-horizontal" id="form-article-add" action="{{url('admin/navbar/'.$field->nav_id)}}" method="post">
			...
			<div style="width: 70%; margin: auto"  >
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<input type="text" class="input-text" value="{{$field->nav_name}}" placeholder="" id="" name="nav_name">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<input type="text" class="input-text" value="{{$field->nav_alias}}" placeholder="" id="" name="nav_alias">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-1">
						<input type="text" class="input-text" value="{{$field->nav_order}}" placeholder="" id="" name="nav_order" width="30px">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-6">
						<input type="text" class="input-text" value="{{$field->nav_url}}" placeholder="" id="" name="nav_url">
					</div>
				</div>
