...
@section('content')
	...
	<section class="Hui-article-box">
		<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="{{url('admin/index')}}" class="maincolor">首页</a> <span class="c-999 en">&gt;</span>
			...
			<span class="c-666">友情链接</span></nav>
		<div class="Hui-article">
			<article class="cl pd-20">
		<form class="form form-horizontal" id="form-article-add" action="{{url('admin/links')}}" method="post">
			{{csrf_field()}}
			<div style="width: 70%; margin: auto"  >
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-1">
						<input type="text" class="input-text" value="0" placeholder="" id="" name="link_ord" width="30px">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-6">
						<input type="text" class="input-text" value="http://" placeholder="" id="" name="link_url">
					</div>
				</div>
