...
@section('content')
	...
	<section class="Hui-article-box">
		<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="{{url('admin/index')}}" class="maincolor">首页</a> <span class="c-999 en">&gt;</span>
			<span class="c-666">编辑分类</span></nav>
		<div class="Hui-article">
			<article class="cl pd-20">
		<form class="form form-horizontal" id="form-article-add" action="{{url('admin/category/'.$field->cate_id)}}" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" value="{{$field->cate_keywords}}" placeholder="" id="" name="cate_keywords">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">分类摘要：</label>
				<div class="formControls col-xs-7">
					<textarea name="cate_description" cols="" rows=""  class="textarea"  placeholder="说点什么...最少输入10个字符">{{$field->cate_description}}</textarea>
